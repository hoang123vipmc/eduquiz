...
export default function LeaderboardPage() {
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4 text-center bg-card rounded-[20px] border border-border animate-in fade-in duration-500">
      <div className="w-20 h-20 bg-muted rounded-full flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(245,158,11,0.2)]">
        <Trophy className="w-10 h-10 text-[#F59E0B]" />
      </div>
      <h3 className="text-2xl font-bold text-foreground mb-3">Bảng xếp hạng</h3>
